...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButton_4.setText(QCoreApplication.translate("MainWindow", u"Obrir arxiu", None))
        self.pushButton_5.setText(QCoreApplication.translate("MainWindow", u"actualitza dades", None))
        self.label_3.setText(QCoreApplication.translate("MainWindow", u"Filtre Manufacture PN", None))
        self.label_6.setText(QCoreApplication.translate("MainWindow", u"Filtre text tot", None))
    # retranslateUi
