...
class Config:
    ...
    FILTERS_CONFIG = [
        ...
        FilterConfig(
            ...
            button_name="filter5_pushButton",
            tag_key="filter5",
            enabled='FILTRE5' in locals()
        ),
    ]

    
    # amaga o desactiva els paràmetres de filtre NO disponibles --> True: amaga; False: deshabilita
    # MODIFICA NOMÉS EL PARÀMETRE 
    ...
    # Visibilitat botons
    COMPONENT_LOOKUP_BUTTON_VISIBILITY = True

    # IMP-002: Rutes relatives al directori del projecte (sense hardcode del nom d'usuari)
    BACKUP_FOLDER   = str(Path(__file__).parent / "backups")
    LCSC_BOM_FOLDER = str(Path(__file__).parent)